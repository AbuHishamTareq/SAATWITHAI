...
* Customer
  ...
  * View booking cancellation reason
  * View booking cancellation date
  * View booking cancellation time
  * View booking cancellation status
  * View booking cancellation reason
  * View booking cancellation date
  * View booking cancellation time
  * View booking cancellation status
...
- Admin
  - Full access
  - Manage users, providers, bookings, payments
