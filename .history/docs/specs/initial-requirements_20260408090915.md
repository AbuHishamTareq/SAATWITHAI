...
The app should be build with Flutter as frontend in client_app folder and Laravel 13 as a backend in backend folder.
...
* The app should have a theme that is easy to use and navigate.
* The app should have a theme that is visually appealing.

## Navigation
* The app should have a navigation bar that is easy to use.
* The app should have a navigation bar that is visually appealing.
* The app should have a navigation bar that is easy to navigate.
