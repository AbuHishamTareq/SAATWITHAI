          ...
          {submitted ? (
            ...
            <>
              ...
              >
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 inset-s ps-3 flex items-center pointer-events-none">
              ...
              <div className="mt-6 text-center">
                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 text-sm text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 font-medium"
                >
                  <ArrowLeft size={16} />
                  {t("forgotPassword.backToLogin")}
                </Link>
